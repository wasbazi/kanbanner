...
app.controller("KanbanController", ["$scope", function($scope) {
}]);

app.controller("StoryListCtrl", ["$scope", "$rootScope", "Story", "State", function($scope, $rootScope, Story, State){
...
app.service("State", ["$rootScope", "$http", function($rootScope, $http){
  var service = {
    states: []
  }
